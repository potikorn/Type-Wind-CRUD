  ...
  return (<>
    <div className={`fixed inset-0 overflow-y-auto ${open ? 'block' : 'hidden'}`}>
      ...
      Leaving: "ease-in duration-200"
        ...
        To: "opacity-0"
    --> */}
        <div className={`fixed inset-0 transition-opacity ease-out duration-300 ${open ? 'opacity-100' : 'opacity-0'}`}>
    ...
    --> */}
        <div className={`inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full ease-out duration-300 ${open ? 'opacity-100 translate-y-0 sm:scale-100' : 'opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95'}`} role="dialog" aria-modal="true" aria-labelledby="modal-headline">
